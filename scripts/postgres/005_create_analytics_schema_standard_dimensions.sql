...
create table analytics.dim_program (
    claims_last_7_days default 0,
    claims_last_28_days default 0,
    claims_total default 0,
    id int primary key,
    treatments_last_7_days default 0,
    treatments_last_28_days default 0,
    treatments_total default 0,
);
...
create table analytics.dim_treatment (
    ...
    id int primary key,
    invoices_last_7_days default 0,
    invoices_last_28_days default 0,
    invoices_total default 0,
    type varchar(25),
);
